	...
	class suite_custom_widget extends WP_Widget {
		...
		public function __construct(){
			parent::__construct(
				...
				esc_html__('Suite Footer About', 'crossfit'), //widget Title
				array(
					//widget Description
					'description' => esc_html__('Footer About Text With Button', 'crossfit')
				)
			);
		}//end construct
		...
		public function form($instance){ 
			...
			$title 			 = !empty($instance['title']) ? $instance['title'] : esc_html__('Title', 'crossfit');
			$description = $instance['description'];
			$button 		 = $instance['button'];
			$button_url	 = !empty($instance['button_url']) ? $instance['button_url'] : esc_html__('http://', 'crossfit');

			?>
			<!-- Title -->
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>">
					<?php echo esc_html__('Title', 'crossfit'); ?>
				</label>
				<input 
					type="text"
					class="widefat"
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('description')); ?>">
					<?php echo esc_html__('Description', 'crossfit'); ?>
				</label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('button')); ?>">
					<?php echo esc_html__('Button Text', 'crossfit'); ?>
				</label>
				<input 
					type="text"
					class="widefat"
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('button_url')); ?>">
					<?php echo esc_html__('Button Url', 'crossfit'); ?>
				</label>
				<input 
					type="url"
					class="widefat"
